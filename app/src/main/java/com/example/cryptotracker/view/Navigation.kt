...
fun MainScreen() {
    ...
    Scaffold(
        bottomBar = { BottomTapBar(navController = navController)}
    ) {
...
@Composable
fun BottomTapBar(navController: NavHostController){
    ...
    BottomAppBar {
        ...
        tabBarItems.forEach { barItem ->
            ...
            NavigationBarItem(
                ...
                icon = {
                    Icon(imageVector = if(isSelected) barItem.selectedIcon else barItem.unselectedIcon,
